...
- **单人 vs AI**:四档难度(简单 / 普通 / 困难 / 极限)。难度同时调整敌方数值、AI 反应速度与战术风格;极限难度的 AI 会智能集火残血。AI 会依据公开视野、雷达误差接触与历史动向组织搜索，长门旗舰还能编组战斗僚机执行前沿警戒、骚扰、集中和拦截。AI 通过大量对抗模拟逐项调校。
- **在线对战与观战**:基于 WebSocket 的实时 PvP，支持公开房、私人房、AI 训练房和对战观战；多人开战前有三秒倒计时。
- **8 名角色**:凉宫春日、阿虚、长门有希、古泉一树、朝比奈1096、朝仓凉子、鹤屋、三味线——每名角色在「主舰位」与「副舰位」拥有不同的技能(主动 / 被动)；三味线的主舰能力目前仍在设计中。
- **机制深度**:
...
- **剧情 PVE 战役**:单人战役菜单另有「电研社的挑战」与「正义必将得到伸张」两张固定编制地图。战役包含立绘台本序幕、专属 AI 友军、全图观测与相位跃迁，以及会被长门逐层解除的限时作弊优势；四档难度分别调整转折时机与敌方压力。
- **公共更新日志**:点击首页页脚版本号可进入 `/changelog`，按版本查看角色、规则与操作体验的更新内容。
...
npm run test:pve     # 校验 PVE 编制、剧情、视野、援军和阶段规则
...
src/
  ...
  pve/                PVE 战役数据、无 DOM 规则运行时与剧情演出层
  i18n/               日英词典与角色文本
