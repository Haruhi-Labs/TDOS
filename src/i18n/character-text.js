export const CHARACTER_TEXT = Object.freeze({
  zh: {
    ...
    yuki: {
      ...
      flagshipSkill: { name: "资讯统合雷达", description: "被动持续以雷达扫描全图，可识别敌人动向，距离越近误差越小。在较近的距离内，可以辨识敌方角色。不会获得真实视野。己方释放的侦察机强化为战斗僚机，获得舰船级视野，并以常规舰炮射速发射16伤害的子弹。" },
  ...
  ja: {
    ...
    yuki: {
      ...
      flagshipSkill: { name: "情報統合レーダー", description: "パッシブでレーダーが常時マップ全域を走査し、敵の動向を捉える。距離が近いほど誤差は小さくなり、近距離では敵キャラクターを識別できる。実視界は得られない。味方が発進させた偵察機は戦闘僚機となり、通常艦と同等の視界を持ち、通常艦砲と同じ連射速度で16ダメージの弾を発射する。" },
