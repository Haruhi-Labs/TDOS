export const CHARACTER_TEXT = Object.freeze({
  zh: {
    ...
    shamisen: {
      ...
      flagshipSkill: { name: "猫爪印记", description: "开局标记一名猎杀目标；全舰队可持续追踪但不会获得真实视野。目标进入真实视野后会被优先锁定，攻击目标时造成双倍伤害；击杀后自动标记下一名敌人。" },
  ...
  ja: {
    ...
    shamisen: {
      ...
      flagshipSkill: { name: "猫の爪印", description: "開幕時に敵1隻を指定し、実視界を得ずに標識だけを追跡する。対象が実視界に入ると優先ロックして2倍のダメージを与え、撃破後は次の敵を自動指定する。" },
  ...
  en: {
    ...
    shamisen: {
      ...
      flagshipSkill: { name: "Claw Mark", description: "Marks one enemy at battle start and tracks only the mark without granting true vision. Once revealed, the target is prioritized and takes double fleet damage; a new target is marked after each kill." },
